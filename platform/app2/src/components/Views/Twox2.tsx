...
const Twox2: React.FC<Props> = ({
  ...
  return (
    <ReactSplit direction={SplitDirection.Horizontal} onResizeStarted={handleResizeStarted}
    onResizeFinished={handleResizeFinished}>
      ...
      <ReactSplit direction={SplitDirection.Vertical}>
        ...
        <Tile title={titles[3]}>
          {getApplicationElement(findAppForPosition(apps, 4))}
        </Tile>
      </ReactSplit>
    </ReactSplit>
  );
