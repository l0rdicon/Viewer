    ...
    return (
        <React.Fragment>
          <div className="m-auto grid grid-rows-2 grid-cols-2 gap-x-2 gap-y-2 py-2 min-w-full h-full">
            <div  className={classnames("col-span-1 min-w-full bg-secondary-dark rounded-lg")}>
            ...
            <div  className={classnames("col-span-1 row-span-2 min-w-full bg-secondary-dark rounded-lg")}>
              <div className="grid h-full place-items-center w-full">
                    { showApps && 
                        <Typography
                            variant="h2"
...
export default ViewTemplateG2x1a;