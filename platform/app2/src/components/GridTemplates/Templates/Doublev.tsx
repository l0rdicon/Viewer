...
const ViewTemplateDoublev = ({
    ...
    return (
        <React.Fragment>
            <div className="m-auto grid grid-rows-2 gap-x-2 gap-y-2 py-2 min-w-full h-full">
...
export default ViewTemplateDoublev;