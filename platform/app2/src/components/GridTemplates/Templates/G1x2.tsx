    ...
    return (
        <React.Fragment>
          <div className="m-auto grid grid-rows-2 grid-cols-2 gap-x-2 gap-y-2 py-2 min-w-full h-full">
            <div  className={classnames("col-span-2 min-w-full bg-secondary-dark rounded-lg")}>
...
export default ViewTemplateG1x2;